...
export default function Card({ data }){
    ...
    const { locationName, description, price } = data;

    return(
        <div className="mt-5 rounded-md w-[800px] flex shadow-md bg-slate-100 leading-6 transition ease-in-out cursor-pointer delay-150 hover:text-white hover:-translate-y-1 hover:scale-70 hover:bg-slate-200 duration-200 focus-visible:outline focus-visible:outline-2">
          <div className="">
          ...
          <div className="flex items-center justify-end ml-36 cursor w-4">
